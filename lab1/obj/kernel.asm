...
void print_regs(struct pushregs *gpr) {
    ...
    802001a8:	b6c50513          	addi	a0,a0,-1172 # 80200d10 <etext+0x28e>
void print_regs(struct pushregs *gpr) {
    ...
    80200360:	c9c50513          	addi	a0,a0,-868 # 80200ff8 <etext+0x576>
}
...
void print_trapframe(struct trapframe *tf) {
    ...
    80200376:	c9e50513          	addi	a0,a0,-866 # 80201010 <etext+0x58e>
void print_trapframe(struct trapframe *tf) {
    ...
    802003c2:	cb250513          	addi	a0,a0,-846 # 80201070 <etext+0x5ee>
}
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003f2:	8d250513          	addi	a0,a0,-1838 # 80200cc0 <etext+0x23e>
    802003f6:	c7dff06f          	j	80200072 <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003fa:	00001517          	auipc	a0,0x1
    802003fe:	8a650513          	addi	a0,a0,-1882 # 80200ca0 <etext+0x21e>
    80200402:	c71ff06f          	j	80200072 <cprintf>
            cprintf("User software interrupt\n");
    80200406:	00001517          	auipc	a0,0x1
    8020040a:	85a50513          	addi	a0,a0,-1958 # 80200c60 <etext+0x1de>
    8020040e:	c65ff06f          	j	80200072 <cprintf>
            cprintf("Supervisor software interrupt\n");
    80200412:	00001517          	auipc	a0,0x1
    80200416:	86e50513          	addi	a0,a0,-1938 # 80200c80 <etext+0x1fe>
    ...
    80200422:	8d250513          	addi	a0,a0,-1838 # 80200cf0 <etext+0x26e>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    8020043a:	6394                	ld	a3,0(a5)
    8020043c:	06400713          	li	a4,100
    80200440:	02e68563          	beq	a3,a4,8020046a <interrupt_handler+0x9e>
            else ticks++;
    80200444:	639c                	ld	a5,0(a5)
    80200446:	00004717          	auipc	a4,0x4
    8020044a:	bca70713          	addi	a4,a4,-1078 # 80204010 <edata>
    ...
    80200458:	6318                	ld	a4,0(a4)
    8020045a:	47a9                	li	a5,10
    8020045c:	02f70e63          	beq	a4,a5,80200498 <interrupt_handler+0xcc>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200472:	87250513          	addi	a0,a0,-1934 # 80200ce0 <etext+0x25e>
    80200476:	bfdff0ef          	jal	ra,80200072 <cprintf>
                num++;
    8020047a:	00004717          	auipc	a4,0x4
    8020047e:	b9670713          	addi	a4,a4,-1130 # 80204010 <edata>
                ticks=0;
    80200482:	00004797          	auipc	a5,0x4
    80200486:	b807bf23          	sd	zero,-1122(a5) # 80204020 <ticks>
                num++;
    8020048a:	631c                	ld	a5,0(a4)
    8020048c:	0785                	addi	a5,a5,1
    8020048e:	00004697          	auipc	a3,0x4
    80200492:	b8f6b123          	sd	a5,-1150(a3) # 80204010 <edata>
    80200496:	b7c9                	j	80200458 <interrupt_handler+0x8c>
}
    80200498:	60a2                	ld	ra,8(sp)
...
void exception_handler(struct trapframe *tf) {
    ...
    8020050c:	71850513          	addi	a0,a0,1816 # 80200c20 <etext+0x19e>
    80200510:	b63ff0ef          	jal	ra,80200072 <cprintf>
            cprintf("ebreak caught at 0x%08x\n", tf->epc);
    80200514:	10843583          	ld	a1,264(s0)
    80200518:	00000517          	auipc	a0,0x0
    8020051c:	72850513          	addi	a0,a0,1832 # 80200c40 <etext+0x1be>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200640:	bdc78793          	addi	a5,a5,-1060 # 80201218 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200694:	9f4a0a13          	addi	s4,s4,-1548 # 80201084 <etext+0x602>
    ...
    802006a0:	b44c0c13          	addi	s8,s8,-1212 # 802011e0 <error_string>
    ...
    8020078e:	b3e60613          	addi	a2,a2,-1218 # 802012c8 <error_string+0xe8>
    ...
    80200922:	99a60613          	addi	a2,a2,-1638 # 802012b8 <error_string+0xd8>
    ...
    80200934:	98060613          	addi	a2,a2,-1664 # 802012b0 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    80200938:	00001417          	auipc	s0,0x1
    8020093c:	97940413          	addi	s0,s0,-1671 # 802012b1 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    802009c8:	8ed40413          	addi	s0,s0,-1811 # 802012b1 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
